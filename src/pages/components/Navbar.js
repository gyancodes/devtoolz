  ...
  <nav className="mt-6 relative max-w-7xl w-full border border-gray-200 rounded-[36px] mx-2 py-3 px-4 md:flex md:items-center md:justify-between md:py-0 md:px-6 lg:px-8 xl:mx-auto bg-none" aria-label="Global">
    ...
    <div id="navbar-collapse-with-animation" className="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:block">
      <div className="flex flex-col gap-y-4 gap-x-0 mt-5 md:flex-row md:items-center md:justify-end md:gap-y-0 md:gap-x-7 md:mt-0 md:pl-7">
        ...
        <a className="font-medium text-white hover:text-white md:py-6 dark:text-gray-white " href="#">Account</a>
        <a className="font-medium text-white hover:text-white md:py-6 dark:text-gray-white " href="#">Work</a>
        <a className="font-medium text-white hover:text-white md:py-6 dark:text-gray-white" href="#">Blog</a> 
