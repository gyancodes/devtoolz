          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <Link href={"/Tools/AITools"}>
              <div className="h-36 sm:h-56 flex flex-col justify-center border border-gray-200 rounded-xl text-center p-4 md:p-5 dark:border-gray-700">
                ...
                <div
                  className="flex justify-center items-center w-12 h-12 bg-gradient-to-br from-blue-600 to-violet-600 rounded-md mx-auto hover:scale-75
             animate-floating"
                >
                  <svg
            ...
            {/* End Icon Block */}
            {/* Icon Block */}
            <Link href={"/Tools/DocumentationMockups"}>
              <div className="h-36 sm:h-56 flex flex-col justify-center border border-gray-200 rounded-xl text-center p-4 md:p-5 dark:border-gray-700">
                {/* Icon */}
                <div
                  className="flex justify-center items-center w-12 h-12 bg-gradient-to-br from-blue-600 to-violet-600 rounded-md mx-auto hover:scale-75
