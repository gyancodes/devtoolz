...
<aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
      <Link href={"/admin/"} className="flex items-center pl-2.5 mb-5">
         <img src="/asset/Devtoolz_whitebg.png" className="h-6 mr-3 sm:h-7" alt="DevToolz" />
         <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">DevToolz</span>
      </Link>
      <ul className="space-y-2 font-medium">
         ...
         <li>
            <Link href={"/admin/component/AddCategory"} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
